...
public class TestRenderToXML
{
	protected static final Logger logger = LoggerFactory.getLogger( TestRenderToTxt.class );

	String directionDefStr = null;
	String txnDataStr = null;
	String encoding = null;

	@Before
	public void setUp() {
		directionDefStr = "<?xml version = \"1.0\" encoding = \"UTF-8\"?>\r\n"
		...
		txnDataStr = "<?xml version = \"1.0\" encoding = \"UTF-8\"?>\r\n"
	...
	public void testRenderToXml() {
		try {
			...
			logger.info( "start" );
			requestToTranslate( "fubon.esb.render.to.xml.1.transform", result.toString() );
			logger.info( "end" );
